                ...
                <div className='w-full inline-block'>
                    <div className='md-float-left block flex justify-between items-center'>
                        ...
                        <div className='md:hidden flex'>
                            <button onClick={() => setIsOpen(!isOpen)} type='button' className='bg-none inline-flex items-center justify-center rounded-md text-landingtext'
                            aria-expanded='false'>  
            ...
            leaveTo='opacity-0 scale-95'>
                {(ref) => (
                    <div className='md:hidden id=mobile-menu flex justify-center'>
                        <div ref={ref} className='text-2xl px-2 pt-2 pb-3 space-y-1 sm:px-3 flex flex-col gap-y-6 justify-center align-center cursor-pointer text-landingtext opacity-50 hover:opacity-100 min-h-screen'>
